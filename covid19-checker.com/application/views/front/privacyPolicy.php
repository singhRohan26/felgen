...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Coiner GmbH, Kirchgasse 2, 5742 Kölliken.</p>
    ...
    <li><strong>Website</strong> refers to Covid-19 Checker, accessible from https://covid19-checker.com/</li>        <li><strong>Service</strong> refers to the Website.</li>
...
<ul>
              <li>By mail: Coiner GmbH, Kirchgasse 2, 5742 Kölliken</li>
  </ul>
        ...
        <div class="footer boxs" id="contact">
            ...
            <div class="boxs">
                ...
                <h2>Coiner GmbH, Kirchgasse 2, Kölliken / Schweiz©2020 COVID19-Checker. All Rights Reserved. <span><a href="<?php echo base_url('Home/policy');?>" >Privacy Policy</a></span></h2>
            </div>
        </div>
        <!--footer end-->

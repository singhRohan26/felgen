<section class="popular_pro mainmargin popularpro1 boxs">
    <form action="<?php echo base_url('Site/dobasicfilteration') ?>" method="post" id="basic_filter_form">
        <div class="popular_pro popular_pro_drop boxs made_in_drop populardrp ">
            <div class="pop_inner boxs all_top">
                <h2>Neuste Felgen</h2>
...
<section class="productlist boxs">
    <div class="container-fluid">
        <div class="productocenter boxs">
            <div data-url="<?php echo base_url('Site/basic_product_wrapper') ?>" id="basic_product_wrapper"></div>
        </div>
    </div>
</section>
...
<head>
    ...
    <title>Felgen Inserate | Admin Login</title>
                    ...
                    <div class="col-xl-7 pa-0">
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method="post" class="md-float-material form-material" action="<?php echo base_url('admin/checkLogin'); ?>" id="common-form">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input class="form-control" placeholder="Passwort" type="password" id="password" name="password">
                                        </div>
                                    </div>
                                    <div class="mb-25">
                                        <a href="<?php echo base_url('admin/forgot-password') ?>"><label for="same-address">Passwort vergessen?</label></a>
                                    </div>

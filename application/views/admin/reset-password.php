...
<head>
    ...
    <title>Felgen Inserate | Reset Password</title>
                    ...
                    <div class="col-xl-7 pa-0">
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method="post" id="common-form" action="<?php echo base_url('admin/resetPassword'); ?>">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Passwort eingeben" type="password" id="password" name="password">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Kennwort bestätigen" type="password" id="cpassword" name="cpassword">
                                    </div>
